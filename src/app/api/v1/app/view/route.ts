...
const additionalViews: Record<string, ReturnType<typeof makeView>> = {
  ...
  // Return the specific view, or generate a meaningful view based on role + view name
  if (allViews[key]) return allViews[key];

  // Generate a meaningful view for any undefined role:view combination
  const viewLabels: Record<string, { title: string; desc: string; icon: string }> = {
    home: { title: getRoleLabel(role), desc: getRoleSubtitle(role), icon: "LayoutDashboard" },
    dashboard: { title: "Dashboard", desc: "Your dashboard overview", icon: "LayoutDashboard" },
    earnings: { title: "Earnings", desc: "Your earnings and income", icon: "Wallet" },
    upcoming: { title: "Upcoming", desc: "Your upcoming items", icon: "Calendar" },
    orders: { title: "Orders", desc: "Manage your orders", icon: "Package" },
    deliveries: { title: "Deliveries", desc: "Track deliveries", icon: "Truck" },
    inventory: { title: "Inventory", desc: "Manage your inventory", icon: "Package" },
    customers: { title: "Customers", desc: "Your customer relationships", icon: "Users" },
    performance: { title: "Performance", desc: "Your performance metrics", icon: "TrendingUp" },
    availability: { title: "Availability", desc: "Set your availability schedule", icon: "Clock" },
    messages: { title: "Messages", desc: "Your message inbox", icon: "MessageSquare" },
    budget: { title: "Budget", desc: "Track your spending", icon: "Wallet" },
    notifications: { title: "Notifications", desc: "Your recent activity", icon: "Bell" },
    profile: { title: "Profile", desc: "Your account settings", icon: "User" },
    menu: { title: "Menu", desc: "Manage your menu", icon: "Utensils" },
    recipes: { title: "Recipes", desc: "Your recipe collection", icon: "FileText" },
    staff: { title: "Staff", desc: "Manage your team", icon: "Users" },
    suppliers: { title: "Suppliers", desc: "Your supplier network", icon: "Truck" },
    sales: { title: "Sales", desc: "Sales analytics", icon: "BarChart3" },
    reports: { title: "Reports", desc: "Generate and view reports", icon: "BarChart3" },
    operations: { title: "Operations", desc: "Daily operations management", icon: "Settings" },
    products: { title: "Products", desc: "Manage your products", icon: "Package" },
    payments: { title: "Payments", desc: "Track payments", icon: "Wallet" },
    compliance: { title: "Compliance", desc: "Compliance tracking", icon: "ShieldCheck" },
    violations: { title: "Violations", desc: "Violation records", icon: "AlertTriangle" },
    schedules: { title: "Schedules", desc: "Your schedule", icon: "Calendar" },
    certificates: { title: "Certificates", desc: "Certificate management", icon: "Award" },
    active: { title: "Active", desc: "Your active items", icon: "Activity" },
    history: { title: "History", desc: "Your activity history", icon: "History" },
    vehicle: { title: "Vehicle", desc: "Your vehicle information", icon: "Bike" },
    riders: { title: "Riders", desc: "Manage riders", icon: "Users" },
    vehicles: { title: "Vehicles", desc: "Manage vehicles", icon: "Truck" },
    routes: { title: "Routes", desc: "Route management", icon: "MapPin" },
    maintenance: { title: "Maintenance", desc: "Maintenance tracking", icon: "Settings" },
    demand: { title: "Demand Forecast", desc: "Predicted demand", icon: "TrendingUp" },
    warehouse: { title: "Warehouse", desc: "Warehouse management", icon: "Building2" },
    kitchens: { title: "Kitchens", desc: "Kitchen management", icon: "Utensils" },
    pending: { title: "Pending Items", desc: "Items awaiting your action", icon: "FileText" },
    "pending-reports": { title: "Pending Reports", desc: "Reports to complete", icon: "FileText" },
    available: { title: "Available", desc: "Available items", icon: "Package" },
    "kitchen-status": { title: "Kitchen Status", desc: "Kitchen operations", icon: "Utensils" },
    "kitchen-calendar": { title: "Kitchen Calendar", desc: "Your cooking schedule", icon: "Calendar" },
    "shopping-list": { title: "Shopping List", desc: "Your shopping list", icon: "ShoppingBag" },
    ingredients: { title: "Ingredients", desc: "Required ingredients", icon: "Package" },
    "repeat-customers": { title: "Repeat Customers", desc: "Your loyal customers", icon: "Users" },
    certifications: { title: "Certifications", desc: "Your certifications", icon: "Award" },
    "income-goals": { title: "Income Goals", desc: "Set and track earnings targets", icon: "TrendingUp" },
    reservations: { title: "Reservations", desc: "Customer reservations", icon: "Calendar" },
    "prep-list": { title: "Prep List", desc: "Preparation tasks", icon: "ClipboardList" },
    schedule: { title: "Schedule", desc: "Your work schedule", icon: "Calendar" },
    cleaning: { title: "Cleaning Tasks", desc: "Assigned cleaning duties", icon: "CheckCircle2" },
    coverage: { title: "Coverage", desc: "Coverage map", icon: "MapPin" },
    incidents: { title: "Incidents", desc: "Incident tracking", icon: "AlertCircle" },
    analytics: { title: "Analytics", desc: "Analytics and insights", icon: "BarChart3" },
    permissions: { title: "Permissions", desc: "Manage user permissions", icon: "KeyRound" },
    billing: { title: "Billing", desc: "Subscription and billing", icon: "Wallet" },
    locations: { title: "Locations", desc: "Manage service locations", icon: "MapPin" },
    policies: { title: "Policies", desc: "Platform policies", icon: "ShieldCheck" },
    invitations: { title: "Invitations", desc: "Invite team members", icon: "Mail" },
    team: { title: "Team", desc: "Manage your team", icon: "Users" },
    organizations: { title: "Organizations", desc: "Manage organizations", icon: "Building2" },
    extensions: { title: "Extensions", desc: "Manage extensions", icon: "Puzzle" },
    "api-explorer": { title: "API Explorer", desc: "Explore the API", icon: "Globe" },
    events: { title: "Events", desc: "Platform event stream", icon: "Activity" },
    connectors: { title: "Connectors", desc: "Manage integrations", icon: "Plug" },
    webhooks: { title: "Webhooks", desc: "Webhook subscriptions", icon: "Webhook" },
    marketplace: { title: "Marketplace", desc: "Extension marketplace", icon: "ShoppingBag" },
    logs: { title: "Logs", desc: "Application logs", icon: "FileText" },
    cli: { title: "CLI", desc: "Command-line interface", icon: "Terminal" },
    listings: { title: "Listings", desc: "Your published items", icon: "Package" },
    revenue: { title: "Revenue", desc: "Earnings tracking", icon: "Wallet" },
    deployments: { title: "Deployments", desc: "Deployment history", icon: "GitBranch" },
    ai: { title: "AI Operations", desc: "AI platform monitoring", icon: "Brain" },
    infrastructure: { title: "Infrastructure", desc: "Infrastructure monitoring", icon: "Server" },
    security: { title: "Security", desc: "Security monitoring", icon: "Shield" },
    governance: { title: "Governance", desc: "Platform governance", icon: "FileCheck" },
    waitlist: { title: "Waitlist Approvals", desc: "Review user applications", icon: "User" },
    developers: { title: "Developer Console", desc: "Developer tools", icon: "Code" },
    "saved-recipes": { title: "Saved Recipes", desc: "Your saved recipes", icon: "Heart" },
    community: { title: "Community Cooking", desc: "Community events", icon: "Users" },
    rewards: { title: "Rewards", desc: "Your rewards", icon: "Star" },
    "favorite-cooks": { title: "Favorite Cooks", desc: "Your favorite cooks", icon: "ChefHat" },
    family: { title: "My Family", desc: "Family management", icon: "Users" },
    "meal-plans": { title: "Meal Plans", desc: "Your meal plans", icon: "Calendar" },
    nutrition: { title: "Nutrition", desc: "Nutrition tracking", icon: "TrendingUp" },
    pantry: { title: "My Pantry", desc: "Pantry management", icon: "Utensils" },
    shopping: { title: "Shopping Assistance", desc: "Shopping help", icon: "ShoppingBag" },
    recommended: { title: "Recommended for You", desc: "Personalized suggestions", icon: "Heart" },
    restaurants: { title: "Restaurants", desc: "Restaurant management", icon: "Store" },
    cooks: { title: "Cooks", desc: "Cook management", icon: "ChefHat" },
  };

  const viewInfo = viewLabels[view] ?? { title: view.charAt(0).toUpperCase() + view.slice(1).replace(/-/g, " "), desc: "Your " + view.replace(/-/g, " ") + " workspace", icon: "FileText" };

  return makeView(
    viewInfo.title,
    viewInfo.desc,
    [
      { label: "Platform Users", value: String(stats.userCount), subtext: "Total registered", icon: "Users", color: "text-blue-600" },
      { label: "Total Bookings", value: String(stats.bookingCount), subtext: "On platform", icon: "Package", color: "text-green-600" },
      { label: "Active Cooks", value: String(stats.cookCount), subtext: "Available", icon: "ChefHat", color: "text-orange-600" },
      { label: "Restaurants", value: String(stats.restaurantCount), subtext: "On platform", icon: "Store", color: "text-purple-600" },
    ],
    [
      { title: viewInfo.title, icon: viewInfo.icon, items: [
        { title: viewInfo.desc, subtitle: `${role.replace(/_/g, " ")} workspace — data will appear here as you use this feature.` },
      ]},
      { title: "Platform Overview", icon: "BarChart3", items: [
        { title: `${stats.userCount} users registered`, subtitle: "Across all roles" },
        { title: `${stats.bookingCount} total bookings`, subtitle: "All time" },
        { title: `${stats.cookCount} active cooks`, subtitle: "On the platform" },
        { title: `${stats.restaurantCount} restaurants`, subtitle: "Registered" },
        { title: `${stats.deliveryCount} deliveries`, subtitle: "Completed" },
      ]},
    ],
  );
}
